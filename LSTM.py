...
"""
# set bais to 1 
for names in model._all_weights:
...
for i in range(5):
    ...
    model.train()
    wandb.init(project="my-test-project", entity="samuelfipps" )
    ...
    for epoch in range(num_epochs):
        ...
        if(overallacc < a[15]): # part of anti overfit
            ...
            for i in (range(0, len(input_data), BATCH_SIZE)):
                ...
                batch_X = batch_X.to(device) #gpu                      
                batch_y = batch_y.to(device) #gpu                   
